...
return [
    ...
    'description' => 'API endpoints for K3 waste management including authentication, master data, and reporting modules.',
    ...
    'base_url' => config('app.url', env('APP_URL', 'http://localhost')),
