...
class UpdateJenisLimbahRequest extends FormRequest
{
    ...
    {
        $jenisLimbahId = $this->route('jenis_limbah')?->kode_limbah ?? $this->route('jenis_limbah');

        return [
            'kode_limbah' => 'required|string|max:10|unique:jenis_limbah,kode_limbah,'.$jenisLimbahId.',kode_limbah',
            'nama_limbah' => 'required|string|max:255',
            'kemasan' => 'required|string|max:255',
            'deskripsi_limbah' => 'nullable|string|max:500',
            'waktu_penyimpanan_hari' => 'sometimes|required|integer|min:1|max:365',
            'karakteristik_id' => 'sometimes|required|exists:karakteristik_limbah,karakteristik_id',
            'kategori_id' => 'sometimes|required|exists:kategori_kegiatan_sumber,kategori_id',
