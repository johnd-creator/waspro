...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('jenis_limbah', function (Blueprint $table) {
            $table->decimal('biaya_pengangkutan_per_kg', 10, 2)->nullable()->comment('Biaya pengangkutan per kilogram (Rupiah)');
            $table->date('mulai_berlaku')->nullable()->comment('Tanggal mulai berlaku biaya pengangkutan');
