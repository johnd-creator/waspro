...
<div class="p-4 sm:p-6 lg:p-8">
    ...
    <!-- Form Section -->
    <div class="rounded-2xl shadow-sm border sm:p-6 lg:p-8" style="background-color: var(--card-bg); border-color: var(--border-primary);">
            ...
            <form action="{{ route('perusahaan-penghasil.store') }}" method="POST">
                ...
                <div class="flex justify-end gap-3 mt-8">
                    ...
                    <button type="submit" class="inline-flex items-center px-6 py-3 text-white font-medium rounded-xl transition-all duration-200 shadow-lg"
                            ...
                            onmouseover="this.style.backgroundColor='var(--accent-primary)'; this.style.boxShadow='var(--shadow-xl)';"
                            onmouseout="this.style.backgroundColor='var(--accent-primary)'; this.style.boxShadow='var(--shadow-lg)';">
