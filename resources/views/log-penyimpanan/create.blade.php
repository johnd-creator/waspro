    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="mb-6 rounded-2xl border shadow-sm"
            ...
            <div class="flex items-center justify-between border-b px-8 py-6" style="border-color: var(--border-primary);">
                <div>
                    <h1 class="mb-2 text-2xl font-bold" style="color: var(--text-primary);">Tambah Log Penyimpanan Limbah
                    </h1>
                ...
                <div class="flex gap-3">
                    <a href="{{ route('log-penyimpanan.index') }}"
                        class="inline-flex items-center rounded-xl bg-slate-600 px-6 py-3 font-medium text-white shadow-lg transition-all duration-200 hover:bg-slate-700 hover:shadow-xl">
                ...
                <form action="{{ route('log-penyimpanan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="tanggal_limbah_masuk" class="mb-2 block text-sm font-medium"
                                    style="color: var(--text-primary);">Tanggal Limbah Masuk <span
                                        class="text-red-500">*</span></label>
                                <input type="date"
                                    class="w-full rounded-lg border px-3 py-2 shadow-sm transition-all duration-200 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('tanggal_limbah_masuk') border-red-500 @enderror"
                            ...
                            <div>
                                <label for="kode_limbah" class="mb-2 block text-sm font-medium"
                                    style="color: var(--text-primary);">Jenis Limbah <span
                                        class="text-red-500">*</span></label>
                                <input type="text"
                                    ...
                                    style="background-color: var(--input-bg); border-color: var(--border-primary); color: var(--input-text);"
                                    id="kode_limbah" name="kode_limbah" value="{{ old('kode_limbah') }}"
                                    placeholder="Pilih jenis limbah" list="jenis_limbah_list" required>
                        ...
                        <!-- Row: Unit Pembangkit (untuk Super Admin tanpa unit) -->
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                <label for="unit_id" class="mb-2 block text-sm font-medium"
                                    style="color: var(--text-primary);">Unit Pembangkit <span
                                        class="text-red-500">*</span></label>
                                <select
                                ...
                                <p class="mt-1 text-sm" style="color: var(--text-tertiary);">Sebagai Super Admin, pilih unit untuk mencatat log limbah ini.</p>
                                @error('unit_id')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                <label for="jumlah_limbah_masuk" class="mb-2 block text-sm font-medium"
                                    style="color: var(--text-primary);">Jumlah Limbah Masuk (Kg) <span
                                        class="text-red-500">*</span></label>
                                <input type="number"
                                    class="w-full rounded-lg border px-3 py-2 shadow-sm transition-all duration-200 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('jumlah_limbah_masuk') border-red-500 @enderror"
                                    style="background-color: var(--input-bg); border-color: var(--border-primary); color: var(--input-text);"
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                <label for="perusahaan_nama" class="mb-2 block text-sm font-medium"
                                    style="color: var(--text-primary);">Perusahaan/Vendor Penghasil Limbah</label>
                                <input type="text"
                                    ...
                                    style="background-color: var(--input-bg); border-color: var(--border-primary); color: var(--input-text);"
                                    id="perusahaan_nama" name="perusahaan_nama" value="{{ old('perusahaan_nama') }}"
                                    placeholder="Masukkan nama perusahaan penghasil limbah" list="perusahaan_list">
                    ...
                    <div class="mt-6">
                        <label for="detail_sumber_limbah" class="mb-2 block text-sm font-medium"
                            style="color: var(--text-primary);">Sumber Kegiatan Limbah <span
                                class="text-red-500">*</span></label>
                        <input type="text"
                            ...
                            style="background-color: var(--input-bg); border-color: var(--border-primary); color: var(--input-text);"
                            id="detail_sumber_limbah" name="detail_sumber_limbah" value="{{ old('detail_sumber_limbah') }}"
                            placeholder="Masukkan sumber kegiatan limbah" list="sumber_limbah_list" required>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea
                            ...
                            style="background-color: var(--input-bg); border-color: var(--border-primary); color: var(--input-text);"
                            id="uraian_pekerjaan" name="uraian_pekerjaan" rows="3"
                            placeholder="Jelaskan asal/usaha pekerjaan limbah ini...">{{ old('uraian_pekerjaan') }}</textarea>
                    ...
                    <!-- Dokumen Pendukung -->
                    <div class="mt-6">
                        <label for="dokumen_limbah" class="mb-2 block text-sm font-medium"
                            style="color: var(--text-primary);">Dokumen Pendukung</label>
                        <input type="file" id="dokumen_limbah" name="dokumen_limbah"
                            ...
                            style="background-color: var(--input-bg); border-color: var(--border-primary); color: var(--input-text);">
                        <p class="mt-2 text-sm text-slate-500">Unggah manifest atau dokumen pendukung lainnya (maksimal
                            {{ number_format(config('app.max_upload_size', 10240) / 1024, 1) }} MB).</p>
                    ...
                    <div class="flex justify-end gap-3 border-t pt-4" style="border-color: var(--border-primary);">
                        <a href="{{ route('log-penyimpanan.index') }}"
                            class="inline-flex items-center rounded-xl px-6 py-3 font-medium text-white transition-all duration-200"
                            style="background-color: var(--text-secondary);">Batal</a>
                        <button type="submit"
                            class="inline-flex items-center rounded-xl bg-blue-600 px-6 py-3 font-medium text-white shadow-lg transition-all duration-200 hover:bg-blue-700 hover:shadow-xl">
