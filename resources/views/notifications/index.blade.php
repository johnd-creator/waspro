...
@section('content')
    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="container-fluid">
            <!-- Page Header Card -->
            <div style="background: var(--caccent-bg-secondary); border-color: var(--border-secondary); color: var(--accent-secondary);"
                class="backdrop-blur-xl border rounded-2xl p-6 shadow-xl shadow-slate-900/5 transition-all duration-300 hover:shadow-2xl hover:shadow-slate-900/10"
                data-aos="fade-up">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div class="flex items-center">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl flex items-center justify-center text-white mr-4 shadow-xl">
                            <i class="fas fa-bell text-2xl"></i>
                        </div>
                        <div>
                            <h1 style="color: var(--text-primary);" class="text-3xl font-bold mb-1 tracking-tight">
                                Notifikasi Sistem</h1>
                            <div class="flex items-center gap-2 text-sm">
                                <a href="{{ route('dashboard') }}" style="color: var(--text-secondary);"
    ...
    <section class="p-4 sm:p-6 lg:p-8">
        <div class="container-fluid">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <!-- Expired Card -->
                <div style="background: var(--card-bg); border: 2px solid var(--border-primary); box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);"
                    class="group backdrop-blur-xl rounded-xl p-4 shadow-lg shadow-red-500/10 hover:shadow-xl hover:shadow-red-500/20 transition-all duration-300 hover:-translate-y-1"
                ...
                <!-- Urgent Card -->
                <div style="background: var(--card-bg); border: 2px solid var(--border-primary); box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);"
                    class="group backdrop-blur-xl rounded-xl p-4 shadow-lg shadow-amber-500/10 hover:shadow-xl hover:shadow-amber-500/20 transition-all duration-300 hover:-translate-y-1"
                ...
                <!-- Critical Card -->
                <div style="background: var(--card-bg); border: 2px solid var(--border-primary); box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);"
                    class="group backdrop-blur-xl rounded-xl p-4 shadow-lg shadow-blue-500/10 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 hover:-translate-y-1"
                ...
                <!-- Warning Card -->
                <div style="background: var(--card-bg); border: 2px solid var(--border-primary); box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);"
                    class="group backdrop-blur-xl rounded-xl p-4 shadow-lg shadow-emerald-500/10 hover:shadow-xl hover:shadow-emerald-500/20 transition-all duration-300 hover:-translate-y-1"
                    data-aos="fade-up" data-aos-delay="400">
                    <div class="flex items-center justify-between mb-3">
                        <div
                            class="p-3 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg shadow-md group-hover:scale-105 transition-transform duration-300">
            ...
            <!-- Notifications List -->
            <div style="background: var(--card-bg); border: 2px solid var(--border-primary); box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);"
                class="backdrop-blur-xl rounded-2xl shadow-xl shadow-slate-900/5 overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-slate-900/10"
                data-aos="fade-up" data-aos-delay="500">
                <!-- Card Header -->
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 p-8 pb-6"
                    style="background: var(--card-bg); border-bottom: 1px solid var(--border-primary);">
                    <div class="flex-1">
                        <div class="flex items-center gap-4 mb-2">
                            <div
                                class="p-4 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-2xl shadow-xl border-2 border-yellow-300 hover:from-yellow-300 hover:to-orange-400 transition-all duration-300 hover:scale-105">
                                <i class="fas fa-bell text-2xl"></i>
                            </div>
                            <h3 class="text-3xl font-bold tracking-tight" style="color: var(--text-primary);">Notifikasi
                                Limbah</h3>
                        </div>
                        <p class="text-lg leading-relaxed" style="color: var(--text-secondary);">Pantau status limbah yang
                            memerlukan perhatian</p>
                    </div>
                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="relative">
                                <button type="button"
                                    class="inline-flex items-center gap-3 px-6 py-3 text-sm font-semibold text-white bg-gradient-to-r from-blue-500 to-blue-600 border-2 border-blue-400 rounded-xl hover:from-blue-600 hover:to-blue-700 hover:border-blue-300 transition-all duration-300 hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-offset-2 shadow-xl hover:shadow-2xl backdrop-blur-sm"
                                    id="filterDropdown" aria-expanded="false">
                                    <i class="fas fa-filter text-base"></i>
                                    <span class="font-bold">Filter: <span id="currentFilter"
                                            class="font-black">Semua</span></span>
                                    <i class="fas fa-chevron-down text-sm ml-1 transition-transform duration-200"
                                        id="filterChevron"></i>
                                </button>
                                <ul id="filterMenu"
                                    class="dropdown-menu dropdown-menu-end absolute right-0 z-50 hidden shadow-2xl border rounded-xl p-2 mt-2 overflow-hidden"
                                    style="background: var(--card-bg); border-color: var(--border-primary);"
                                    aria-labelledby="filterDropdown">
                                    <li><a class="dropdown-item rounded-lg py-3 px-4 filter-option active d-flex align-items-center gap-3 font-medium transition-colors duration-200"
                                            href="#" data-filter="all" style="color: var(--text-primary);"><i
                                                class="fas fa-list text-blue-600"></i><span>Semua Notifikasi</span></a></li>
                                    <li>
                                        <hr class="dropdown-divider my-2" style="border-color: var(--border-primary);">
                                    </li>
                                    <li><a class="dropdown-item rounded-lg py-3 px-4 filter-option d-flex align-items-center gap-3 font-medium transition-colors duration-200"
                                            href="#" data-filter="expired" style="color: var(--text-primary);"><i
                                                class="fas fa-exclamation-triangle text-red-600"></i><span>Kadaluarsa</span></a>
                                    </li>
                                    <li><a class="dropdown-item rounded-lg py-3 px-4 filter-option d-flex align-items-center gap-3 font-medium transition-colors duration-200"
                                            href="#" data-filter="urgent" style="color: var(--text-primary);"><i
                                                class="fas fa-clock text-amber-600"></i><span>Mendesak</span></a></li>
                                    <li><a class="dropdown-item rounded-lg py-3 px-4 filter-option d-flex align-items-center gap-3 font-medium transition-colors duration-200"
                                            href="#" data-filter="critical" style="color: var(--text-primary);"><i
                                                class="fas fa-bell text-blue-600"></i><span>Kritis</span></a></li>
                                    <li><a class="dropdown-item rounded-lg py-3 px-4 filter-option d-flex align-items-center gap-3 font-medium transition-colors duration-200"
                                            href="#" data-filter="warning" style="color: var(--text-primary);"><i
                                                class="fas fa-info-circle text-emerald-600"></i><span>Peringatan</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="p-0">
                    ...
                    <div class="text-center py-12 px-6" id="empty-state" style="display: none;">
                        ...
                        <div class="max-w-sm mx-auto">
                            ...
                            <p style="color: var(--text-secondary);" class="text-sm leading-relaxed mb-6">Saat ini tidak ada
                                limbah yang memerlukan perhatian khusus. Sistem akan memberitahu Anda jika ada limbah yang
                                mendekati masa kadaluarsa.</p>
                            <button type="button"
                                class="inline-flex items-center gap-3 px-6 py-3 text-sm font-semibold text-white bg-gradient-to-r from-emerald-500 to-emerald-600 border-2 border-emerald-400 rounded-xl hover:from-emerald-600 hover:to-emerald-700 hover:border-emerald-300 transition-all duration-300 hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-emerald-300 focus:ring-offset-2 shadow-xl hover:shadow-2xl backdrop-blur-sm"
                                onclick="refreshNotifications()">
                                <i class="fas fa-sync-alt text-base"></i>
    ...
    <script>
        $(document).ready(function () {
            ...
            function loadNotifications() {
                $.get('{{ route("notifications.expiry") }}', function (data) {
...
@push('styles')
    <style>
        ...
        .shadow-slate-900\/5 {
            box-shadow: 0 10px 15px -3px rgba(15, 23, 42, 0.05), 0 4px 6px -2px rgba(15, 23, 42, 0.025);
        }
