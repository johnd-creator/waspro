        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Kategori Kegiatan Sumber</h3>
                    <div class="card-tools">
                        <a href="{{ route('kategori-kegiatan-sumber.show', $kategoriKegiatanSumber) }}" class="btn btn-info">
                ...
                <div class="card-body">
                    <form action="{{ route('kategori-kegiatan-sumber.update', $kategoriKegiatanSumber) }}" method="POST">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('kategori-kegiatan-sumber.show', $kategoriKegiatanSumber) }}" class="btn btn-secondary me-2">Batal</a>
