        ...
        <div style="padding: 2rem; border-bottom: 1px solid var(--border-primary);" class="dark:border-gray-700">
            <div class="flex justify-between items-start">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('kategori-kegiatan-sumber.edit', $kategoriKegiatanSumber) }}" class="inline-flex items-center px-6 py-3 text-white font-medium rounded-xl transition-all duration-200 shadow-lg" style="background-color: var(--accent-primary);" onmouseover="this.style.boxShadow='var(--shadow-xl)';" onmouseout="this.style.boxShadow='var(--shadow-lg)';">
