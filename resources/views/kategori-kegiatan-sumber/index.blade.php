...
@section('content')
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 mb-6">
        <div class="px-6 py-6 border-b border-slate-200 flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-slate-800 mb-2">Data Kategori Kegiatan Sumber</h1>
                <p class="text-slate-600">Kelola dan pantau data kategori kegiatan sumber dengan mudah</p>
            </div>
        ...
        <div class="px-6 py-6">
            <p class="text-slate-600 text-sm">Daftar kategori kegiatan sumber yang terdaftar dalam sistem</p>
        </div>
    </div>
            ...
            <table class="w-full min-w-[700px]">
                <thead class="bg-gradient-to-r from-slate-800 to-slate-700 text-white">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-sm font-semibold min-w-[400px]">Nama Kategori</th>
                        ...
                        <tr class="hover:bg-slate-50/50 transition-all duration-200 border-b border-slate-100 last:border-b-0">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <div class="font-semibold text-slate-900 text-sm">{{ $kategori->nama_kategori }}</div>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-1">
                                    <a href="{{ route('kategori-kegiatan-sumber.show', $kategori) }}"
                                       ...
                                       title="Lihat Detail ({{ $kategori->nama_kategori }})"
                                       target="_self">
                                    ...
                                    <form action="{{ route('kategori-kegiatan-sumber.destroy', $kategori) }}"
                                        ...
                                        <button type="submit" class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-red-100 hover:bg-red-200 text-red-600 transition-colors"
                                                ...
                                                onclick="return handleDeleteConfirm(event, 'Apakah Anda yakin ingin menghapus kategori kegiatan sumber {{ $kategori->nama_kategori }}?')">
                        ...
                        <tr>
                            <td colspan="3" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    <i class="fas fa-list-alt text-6xl text-slate-300 mb-4"></i>
                                    <h3 class="text-lg font-medium text-slate-900 mb-2">Belum ada data kategori kegiatan sumber</h3>
                                    <p class="text-slate-500 mb-4">Mulai dengan menambahkan kategori kegiatan sumber pertama Anda</p>
                                    <a href="{{ route('kategori-kegiatan-sumber.create') }}" class="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl transition-colors">
