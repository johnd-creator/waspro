    ...
    <div class="rounded-2xl shadow-sm border mb-6" style="background-color: var(--card-bg); border-color: var(--border-primary);">
        <div class="px-6 py-6 border-b flex justify-between items-center" style="border-color: var(--border-primary);">
            ...
            <div class="flex gap-3">
                <a href="{{ route('jenis-limbah.index') }}" class="inline-flex items-center px-6 py-3 font-medium text-white rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl" style="background-color: var(--text-secondary); hover:background-color: var(--text-primary);">
