        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Jenis Limbah</h3>
                    <div class="card-tools">
                        <a href="{{ route('jenis-limbah.show', $jenisLimbah) }}" class="btn btn-info">
                ...
                <div class="card-body">
                    <form action="{{ route('jenis-limbah.update', $jenisLimbah) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('batas_penyimpanan_hari') is-invalid @enderror" 
                                           ...
                                           value="{{ old('batas_penyimpanan_hari', $jenisLimbah->batas_penyimpanan_hari) }}" 
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('jenis-limbah.show', $jenisLimbah) }}" class="btn btn-secondary me-2">Batal</a>
