                    ...
                    <form action="{{ route('pengguna-sistem.store') }}" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <small class="text-muted">Kata sandi harus minimal 8 karakter</small>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label for="kata_sandi_confirmation" class="form-label">Konfirmasi Kata Sandi <span class="text-danger">*</span></label>
                                <div class="input-group">
