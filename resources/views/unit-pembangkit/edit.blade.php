...
<div class="px-2 py-4">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 mb-6">
        <div class="px-6 py-6 border-b border-slate-200 flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-slate-800 mb-2">Edit Unit Pembangkit</h1>
                <p class="text-slate-600">Perbarui informasi unit pembangkit listrik</p>
            </div>
            <div class="flex gap-3">
                <a href="{{ route('unit-pembangkit.show', $unitPembangkit) }}" class="inline-flex items-center px-6 py-3 bg-slate-600 hover:bg-slate-700 text-white font-medium rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl">
        ...
        <div class="px-6 py-6">
            <form method="POST" action="{{ route('unit-pembangkit.update', $unitPembangkit) }}">
                ...
                <div class="flex justify-end gap-3 pt-6 mt-6 border-t border-slate-200">
                    <a href="{{ route('unit-pembangkit.show', $unitPembangkit) }}" class="inline-flex items-center px-6 py-3 bg-slate-600 hover:bg-slate-700 text-white font-medium rounded-xl transition-all duration-200">
                        <i class="fas fa-arrow-left mr-2"></i> Kembali
                    </a>
