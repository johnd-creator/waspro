...
@section('content')
    <div class="min-h-screen p-4 sm:p-6 lg:p-8"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-3 mb-4">
            ...
            <!-- Waste Types Card -->
            <div style="background: var(--card-bg); border-color: var(--border-primary);"
                class="group backdrop-blur-xl border rounded-xl p-4 shadow-lg shadow-emerald-500/10 hover:shadow-xl hover:shadow-emerald-500/20 transition-all duration-300 hover:-translate-y-1"
                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="text-right">
                        <div style="color: var(--text-primary);" class="text-2xl font-bold">
                            {{ number_format($totalWasteTypes) }}</div>
                            ...
                            @if($recentActivities->count() > 0)
                                @foreach($recentActivities as $activity)
                                    <div class="p-4 transition-colors duration-200 cursor-pointer"
                                        onmouseover="this.style.background='var(--hover-bg)'"
                                        onmouseout="this.style.background='transparent'"
                                        data-href="{{ route('log-penyimpanan.show', $activity) }}">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-4">
                                                <!-- Status Icon -->
                                                <div class="flex-shrink-0">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div style="color: var(--text-secondary);"
                                                        ...
                                                        <span><i
                                                                class="fas fa-building mr-1"></i>{{ $activity->unitPembangkit->nama_unit ?? 'N/A' }}</span>
                                                        <span><i
                                    ...
                                    <div class="space-y-2">
                                        <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                                            <h4 style="color: var(--text-primary);" class="font-bold text-lg">
                                                {{ $waste->nama_limbah }}</h4>
                                            <span
                                                style="color: var(--text-secondary);">{{ $waste->nama_perusahaan ?? '-' }}</span>
                                        </div>
                                        <div style="color: var(--text-secondary);" class="flex flex-col sm:flex-row gap-4 text-sm">
                                            <span><i class="fas fa-building mr-2"></i>{{ $waste->nama_unit }}</span>
                                            <span><i
