            ...
            <table class="min-w-full w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-b" style="border-color: var(--border-primary);" onmouseover="this.style.backgroundColor='var(--hover-bg)'" onmouseout="this.style.backgroundColor='transparent'">
                        <td class="px-4 py-3 text-sm font-medium" style="color: var(--text-primary);">{{ $stats['nama_perusahaan'] }}</td>
        ...
        <table class="min-w-full w-full">
            ...
            <tbody>
                ...
                <tr class="border-b" style="border-color: var(--border-primary);" onmouseover="this.style.backgroundColor='var(--hover-bg)'" onmouseout="this.style.backgroundColor='transparent'">
                    ...
                    <td class="px-4 py-3 text-sm font-medium" style="color: var(--text-primary);">{{ $log->perusahaanPenghasil->nama_perusahaan ?? 'Internal' }}</td>
