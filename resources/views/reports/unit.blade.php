...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
        <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100 dark:border-gray-800">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Laporan Unit Pembangkit</h3>
        ...
        <div class="p-6">
            ...
            <div class="mb-4 flex items-center gap-2">
                <a href="{{ route('reports.unit.export', ['format' => 'pdf']) }}?{{ http_build_query(request()->all()) }}" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-white">
                    <i class="fas fa-file-pdf"></i> Export PDF
                </a>
                <a href="{{ route('reports.unit.export', ['format' => 'excel']) }}?{{ http_build_query(request()->all()) }}" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white">
            ...
            <div class="mb-6 overflow-hidden rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
                <div class="px-4 py-3 bg-gray-50 dark:bg-gray-800/60 border-b border-gray-100 dark:border-gray-800">
                    <h5 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Ringkasan per Unit</h5>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-800/60">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-300">Efisiensi (%)</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-600 dark:text-gray-300">Rata-rata Hari Penyimpanan</th>
                        ...
                        <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-100 dark:divide-gray-800">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/60">
                                <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100 font-medium">{{ $stats['nama_unit'] }}</td>
                                ...
                                <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-200">{{ number_format($stats['efficiency_rate'], 2) }}</td>
                                <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-200">{{ number_format($stats['avg_storage_days'], 1) }}</td>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-100 dark:divide-gray-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/60">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100 font-medium">{{ $log->unitPembangkit->nama_unit ?? '-' }}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="8" class="px-4 py-6 text-center text-sm text-gray-500 dark:text-gray-400">Tidak ada data untuk filter yang dipilih</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
