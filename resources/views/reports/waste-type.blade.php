...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
        <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100 dark:border-gray-800">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Laporan Jenis Limbah</h3>
        ...
        <div class="p-6">
            ...
            <form method="GET" action="{{ route('reports.waste-type') }}" class="mb-6">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div>
                        <label for="jenis_limbah_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Jenis Limbah</label>
                        <select name="jenis_limbah_id" id="jenis_limbah_id" class="mt-1 block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="mb-4 flex items-center gap-2">
                <a href="{{ route('reports.waste-type.export', ['format' => 'pdf']) }}?{{ http_build_query(request()->all()) }}" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-white">
                    <i class="fas fa-file-pdf"></i> Export PDF
                </a>
                <a href="{{ route('reports.waste-type.export', ['format' => 'excel']) }}?{{ http_build_query(request()->all()) }}" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white">
            ...
            <div class="mb-6 overflow-hidden rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
                <div class="px-4 py-3 bg-gray-50 dark:bg-gray-800/60 border-b border-gray-100 dark:border-gray-800">
                    <h5 class="text-sm font-semibold text-gray-900 dark:text-gray-100">Ringkasan per Jenis Limbah</h5>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-100 dark:divide-gray-800">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/60">
                                <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100 font-medium">{{ $stats['nama_limbah'] }}</td>
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-100 dark:divide-gray-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/60">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100 font-medium">
                                <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ring-1 ring-sky-200/50 bg-sky-50 text-sky-700 dark:ring-sky-400/30 dark:bg-sky-400/10 dark:text-sky-300">{{ $log->jenisLimbah->nama_limbah ?? 'Unknown' }}</span>
                            </td>
